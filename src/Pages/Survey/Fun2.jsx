        ...
        <div className="items-center w-full">
          ...
          <div className="flex flex-row-reverse items-center mt-20  w-1/2">
            ...
            >
              ...
              <span className="now">Yes!</span>
              <span className="play">Yes</span>
            </button>
          </div>
        </div>
      </div>
...
//         <div className="items-center w-full">
//           <div className="">
//             <h1 className="font-bold pt-12 md:pt-48 text-white text-3xl flex text-center justify-center">
//               Are You Gay?
//             </h1>
//           </div>
//           <div className="flex flex-col md:flex-row items-center md:mt-20  w-full md:w-1/2">
//             <button
//               className="yes"
//               style={{
//                 position: 'absolute',
...
//                 transform: 'translateX(-50%)', // Centered horizontally on mobile
//               }}
//               onClick={no}
//             >
//               <svg
